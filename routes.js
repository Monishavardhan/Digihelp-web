...
router.get('/callbacks', isAdmin, async (req, res) => {
    const callbacks = await Callbacks.find().sort({ date: "asc" });
...
router.get('/admin/dashboard', isAdmin , async (req, res) => {
    ...
    res.render('admin/dashboard', { allUsers: allUsers, callbacks: callbacks, followUps: followUps, paid: paid, notInterested: notInterested, newLeads: newLeads })
});
